...
import { Taum, Vetyst, Vohrr, xunni, Seriousnes, ToppleTheNun, Putro, Resinger } from 'CONTRIBUTORS';
import { SpellLink } from 'interface';

export default [
  change(date(2023, 11, 23), <>Adjustments to the APL for patch 10.2 based on the updated Wowhead / Icy-Veins guides</>, Resinger),
